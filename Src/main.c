...
void SystemClock_Config(void)
{
  ...
  /** HSI-only clock: 48 MHz SYSCLK / 48 MHz USB.
   *  Blue Pill clones often have a missing, bad, or 12 MHz HSE crystal.
   *  Wrong HSE breaks USB enumeration even when the MCU appears to run. */
